...
const Spell = ({setQuiz}) => {
  ...
  return (
    <div className="font-medium text-lg">
      <h1 className="my-2">
        Within the grounds lies the spell known for conjuring a patronus, a powerful manifestation of positive energy used to repel dark forces. Which spell am I ?
      </h1>
